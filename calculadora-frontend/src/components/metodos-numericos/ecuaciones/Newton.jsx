...
const Newton = () => {
  ...
  const calcularNewton = async () => {
    setLoading(true)
    setError(null)
    
    try {
      const response = await axios.post(`${API_URL}/newton`, {
        f: funcion,
        x0: Number(x0),
  ...
  return (
    <CalculatorLayout
      ...
      description="Encuentra raíces de ecuaciones no lineales utilizando la derivada de la función para aproximar la raíz mediante tangentes sucesivas."
      onCalculate={calcularNewton}
