...
const GaussJordan = () => {
  ...
  const calcularGaussJordan = async () => {
    setLoading(true)
    setError(null)
    ...
    try {
      ...
      const response = await axios.post(`${API_URL}/gauss-jordan`, {
        A,
        b
      });
  ...
  return (
    <CalculatorLayout
      ...
      description="Resuelve sistemas de ecuaciones lineales mediante eliminación gaussiana y reducción a matriz identidad para obtener directamente los valores de las incógnitas."
      onCalculate={calcularGaussJordan}
